...
if [ -d "/runpod-volume" ]; then
  ...
  python -u /workspace/comfyflux/main.py --port 3000 --use-sage-attention --base-directory /workspace/comfyflux --disable-auto-launch --disable-metadata --verbose "${COMFY_LOG_LEVEL}" --log-stdout &
  # deactivate
